...
static const struct DebugMenuOption sDebugMenu_Actions_Scripts[] =
{
    ...
    { COMPOUND_STRING("Enable DexNav"), DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
...
{
    enum Ability abilityId = GetAbilityBySpecies(sDebugMonData->species, abilityNum, FALSE);
    StringCopy(gStringVar2, gText_DigitIndicator[digit]);
