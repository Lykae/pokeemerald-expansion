...
//TODO REMOVE
static const char *const sMonDataFieldNames[] =
{
    [MON_DATA_PERSONALITY] = "MON_DATA_PERSONALITY",
    [MON_DATA_STATUS] = "MON_DATA_STATUS",
    [MON_DATA_OT_ID] = "MON_DATA_OT_ID",
    [MON_DATA_LANGUAGE] = "MON_DATA_LANGUAGE",
    [MON_DATA_SANITY_IS_BAD_EGG] = "MON_DATA_SANITY_IS_BAD_EGG",
    [MON_DATA_SANITY_HAS_SPECIES] = "MON_DATA_SANITY_HAS_SPECIES",
    [MON_DATA_SANITY_IS_EGG] = "MON_DATA_SANITY_IS_EGG",
    [MON_DATA_OT_NAME] = "MON_DATA_OT_NAME",
    [MON_DATA_MARKINGS] = "MON_DATA_MARKINGS",
    [MON_DATA_CHECKSUM] = "MON_DATA_CHECKSUM",
    [MON_DATA_HP] = "MON_DATA_HP",
    [MON_DATA_IS_SHINY] = "MON_DATA_IS_SHINY",
    [MON_DATA_HIDDEN_NATURE] = "MON_DATA_HIDDEN_NATURE",
    [MON_DATA_HP_LOST] = "MON_DATA_HP_LOST",
    [MON_DATA_DAYS_SINCE_FORM_CHANGE] = "MON_DATA_DAYS_SINCE_FORM_CHANGE",
    [MON_DATA_ENCRYPT_SEPARATOR] = "MON_DATA_ENCRYPT_SEPARATOR",
    [MON_DATA_NICKNAME] = "MON_DATA_NICKNAME",
    [MON_DATA_NICKNAME10] = "MON_DATA_NICKNAME10",
    [MON_DATA_SPECIES] = "MON_DATA_SPECIES",
    [MON_DATA_HELD_ITEM] = "MON_DATA_HELD_ITEM",
    [MON_DATA_MOVE1] = "MON_DATA_MOVE1",
    [MON_DATA_MOVE2] = "MON_DATA_MOVE2",
    [MON_DATA_MOVE3] = "MON_DATA_MOVE3",
    [MON_DATA_MOVE4] = "MON_DATA_MOVE4",
    [MON_DATA_PP1] = "MON_DATA_PP1",
    [MON_DATA_PP2] = "MON_DATA_PP2",
    [MON_DATA_PP3] = "MON_DATA_PP3",
    [MON_DATA_PP4] = "MON_DATA_PP4",
    [MON_DATA_PP_BONUSES] = "MON_DATA_PP_BONUSES",
    [MON_DATA_COOL] = "MON_DATA_COOL",
    [MON_DATA_BEAUTY] = "MON_DATA_BEAUTY",
    [MON_DATA_CUTE] = "MON_DATA_CUTE",
    [MON_DATA_EXP] = "MON_DATA_EXP",
    [MON_DATA_HP_EV] = "MON_DATA_HP_EV",
    [MON_DATA_ATK_EV] = "MON_DATA_ATK_EV",
    [MON_DATA_DEF_EV] = "MON_DATA_DEF_EV",
    [MON_DATA_SPEED_EV] = "MON_DATA_SPEED_EV",
    [MON_DATA_SPATK_EV] = "MON_DATA_SPATK_EV",
    [MON_DATA_SPDEF_EV] = "MON_DATA_SPDEF_EV",
    [MON_DATA_FRIENDSHIP] = "MON_DATA_FRIENDSHIP",
    [MON_DATA_SMART] = "MON_DATA_SMART",
    [MON_DATA_POKERUS] = "MON_DATA_POKERUS",
    [MON_DATA_POKERUS_STRAIN] = "MON_DATA_POKERUS_STRAIN",
    [MON_DATA_POKERUS_DAYS_LEFT] = "MON_DATA_POKERUS_DAYS_LEFT",
    [MON_DATA_MET_LOCATION] = "MON_DATA_MET_LOCATION",
    [MON_DATA_MET_LEVEL] = "MON_DATA_MET_LEVEL",
    [MON_DATA_MET_GAME] = "MON_DATA_MET_GAME",
    [MON_DATA_POKEBALL] = "MON_DATA_POKEBALL",
    [MON_DATA_HP_IV] = "MON_DATA_HP_IV",
    [MON_DATA_ATK_IV] = "MON_DATA_ATK_IV",
    [MON_DATA_DEF_IV] = "MON_DATA_DEF_IV",
    [MON_DATA_SPEED_IV] = "MON_DATA_SPEED_IV",
    [MON_DATA_SPATK_IV] = "MON_DATA_SPATK_IV",
    [MON_DATA_SPDEF_IV] = "MON_DATA_SPDEF_IV",
    [MON_DATA_IS_EGG] = "MON_DATA_IS_EGG",
    [MON_DATA_ABILITY_NUM] = "MON_DATA_ABILITY_NUM",
    [MON_DATA_TOUGH] = "MON_DATA_TOUGH",
    [MON_DATA_SHEEN] = "MON_DATA_SHEEN",
    [MON_DATA_OT_GENDER] = "MON_DATA_OT_GENDER",
    [MON_DATA_COOL_RIBBON] = "MON_DATA_COOL_RIBBON",
    [MON_DATA_BEAUTY_RIBBON] = "MON_DATA_BEAUTY_RIBBON",
    [MON_DATA_CUTE_RIBBON] = "MON_DATA_CUTE_RIBBON",
    [MON_DATA_SMART_RIBBON] = "MON_DATA_SMART_RIBBON",
    [MON_DATA_TOUGH_RIBBON] = "MON_DATA_TOUGH_RIBBON",
    [MON_DATA_LEVEL] = "MON_DATA_LEVEL",
    [MON_DATA_MAX_HP] = "MON_DATA_MAX_HP",
    [MON_DATA_ATK] = "MON_DATA_ATK",
    [MON_DATA_DEF] = "MON_DATA_DEF",
    [MON_DATA_SPEED] = "MON_DATA_SPEED",
    [MON_DATA_SPATK] = "MON_DATA_SPATK",
    [MON_DATA_SPDEF] = "MON_DATA_SPDEF",
    [MON_DATA_MAIL] = "MON_DATA_MAIL",
    [MON_DATA_SPECIES_OR_EGG] = "MON_DATA_SPECIES_OR_EGG",
    ...
    [MON_DATA_VICTORY_RIBBON] = "MON_DATA_VICTORY_RIBBON",
    [MON_DATA_ARTIST_RIBBON] = "MON_DATA_ARTIST_RIBBON",
    [MON_DATA_EFFORT_RIBBON] = "MON_DATA_EFFORT_RIBBON",
    [MON_DATA_MARINE_RIBBON] = "MON_DATA_MARINE_RIBBON",
    [MON_DATA_LAND_RIBBON] = "MON_DATA_LAND_RIBBON",
    [MON_DATA_SKY_RIBBON] = "MON_DATA_SKY_RIBBON",
    [MON_DATA_COUNTRY_RIBBON] = "MON_DATA_COUNTRY_RIBBON",
    [MON_DATA_NATIONAL_RIBBON] = "MON_DATA_NATIONAL_RIBBON",
    [MON_DATA_EARTH_RIBBON] = "MON_DATA_EARTH_RIBBON",
    [MON_DATA_WORLD_RIBBON] = "MON_DATA_WORLD_RIBBON",
    [MON_DATA_MODERN_FATEFUL_ENCOUNTER] = "MON_DATA_MODERN_FATEFUL_ENCOUNTER",
    [MON_DATA_KNOWN_MOVES] = "MON_DATA_KNOWN_MOVES",
    [MON_DATA_RIBBON_COUNT] = "MON_DATA_RIBBON_COUNT",
    [MON_DATA_RIBBONS] = "MON_DATA_RIBBONS",
    [MON_DATA_HYPER_TRAINED_HP] = "MON_DATA_HYPER_TRAINED_HP",
    [MON_DATA_HYPER_TRAINED_ATK] = "MON_DATA_HYPER_TRAINED_ATK",
    [MON_DATA_HYPER_TRAINED_DEF] = "MON_DATA_HYPER_TRAINED_DEF",
    [MON_DATA_HYPER_TRAINED_SPEED] = "MON_DATA_HYPER_TRAINED_SPEED",
    [MON_DATA_HYPER_TRAINED_SPATK] = "MON_DATA_HYPER_TRAINED_SPATK",
    [MON_DATA_HYPER_TRAINED_SPDEF] = "MON_DATA_HYPER_TRAINED_SPDEF",
    [MON_DATA_IS_SHADOW] = "MON_DATA_IS_SHADOW",
    [MON_DATA_DYNAMAX_LEVEL] = "MON_DATA_DYNAMAX_LEVEL",
    [MON_DATA_GIGANTAMAX_FACTOR] = "MON_DATA_GIGANTAMAX_FACTOR",
    [MON_DATA_TERA_TYPE] = "MON_DATA_TERA_TYPE",
    [MON_DATA_EVOLUTION_TRACKER] = "MON_DATA_EVOLUTION_TRACKER",
};
...
u32 GetMonData3(struct Pokemon *mon, s32 field, u8 *data)
{
    ...
    if (field < ARRAY_COUNT(sMonDataFieldNames) && sMonDataFieldNames[field] != NULL)
        name = sMonDataFieldNames[field];

    name = sMonDataFieldNames[field];
    DebugPrintf("FIELD: %s (%d) --- VALUE: %d\n", name, field, ret);
    // END REMOVE
    return ret;
}
