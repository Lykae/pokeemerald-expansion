...
#define RANDOMIZER_FLAG_WILD_MON                      FLAG_RANDOMIZER_FEATURES_ENABLED
#endif

#ifndef FORCE_RANDOMIZE_FIELD_ITEMS
#define RANDOMIZER_FLAG_FIELD_ITEMS                   FLAG_RANDOMIZER_FEATURES_ENABLED
#endif

#ifndef FORCE_RANDOMIZE_TRAINER_MON
#define RANDOMIZER_FLAG_TRAINER_MON                   FLAG_RANDOMIZER_FEATURES_ENABLED
#endif

#ifndef FORCE_RANDOMIZE_FIXED_MON
#define RANDOMIZER_FLAG_FIXED_MON                     FLAG_RANDOMIZER_FEATURES_ENABLED
#endif

#ifndef FORCE_RANDOMIZE_STARTER_AND_GIFT_MON
#define RANDOMIZER_FLAG_STARTER_AND_GIFT_MON          FLAG_RANDOMIZER_FEATURES_ENABLED
#endif

#ifndef FORCE_RANDOMIZE_EGG_MON
#define RANDOMIZER_FLAG_EGG_MON                       FLAG_RANDOMIZER_FEATURES_ENABLED
#endif

#ifndef FORCE_RANDOMIZE_ABILITIES
#define RANDOMIZER_FLAG_ABILITIES                     FLAG_RANDOMIZER_ABILITY_ENABLED
#endif
